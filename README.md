...
I have been working on a book for my sabbatical and AI text completion keeps popping up in my editor and I keep swatting it away, though sometimes it does suggest good ideas. But mostly, it is rather annoying. For me, relegating grunt work to AI allows me to spend more time on ideation, and that's how my book work has been, as I use AI for hours chasing down interesting historical events as it is certainly a good research (search) engine. And it can be a huge distraction, but research distractions are quite enjoyable. 
...
<video src="artifacts/quantum_phynance.mov" type="video/quicktime" controls title="Video of the AI writing" width="100%"></video>
